package com.motman_doctor.tags;

public class Tags {

    public static String base_url = "http://motmaien.lamah005.com/";
    ...
    public static final String not_tag = "doctory_doctor_not_tag";
    public static final int not_id = 3254;
    //doctoryapp2@gmail.com‬  aass@123456
